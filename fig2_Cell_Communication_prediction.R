...
#load("00.Data/LR_pair_ath.RDa") # LR pair
...
saveRDS(LRp, paste0("LRp_CellType.revised/",args[1],".LRp_CellType.0.1.rds"))

LRp <- LRp[which(LRp$Pvalue<0.05),]
write.table(LRp, paste0("LRp_CellType.revised/",args[1],".LRp_CellType.test.0.1.tsv"), quote = F, sep = "\t", row.names = F, col.names = T)
